...
1.  How could we incorporate teacher names into the coding?

2.  Are there other ways we could sort the data besides descending and ascending order?

3.  How could we determine which classes are more popular than others?
